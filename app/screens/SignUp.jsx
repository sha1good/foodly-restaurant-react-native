...
const SignUp = ({ navigation }) => {
  ...
  const isLoading = SignupStore((state) => state.isLoading)
  const isObsecure = SignupStore((state) => state.isObsecure);
  const toggleLoader = SignupStore((state) => state.toggleLoader);
            ...
            <View>
              ...
              <View style={styles.wrapper}>
                ...
                >
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      SignupStore.getState().toggleObsecure(!isObsecure);
                    }}
                  >
                    <MaterialCommunityIcons
